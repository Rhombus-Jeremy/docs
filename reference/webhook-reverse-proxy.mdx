...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <div className="p-4 border border-red-200 rounded-lg bg-red-50">
    ...
    <ul className="text-red-800 text-sm space-y-1">
      <li>• Use key-based SSH authentication only</li>
  ...
  <div className="p-4 border border-yellow-200 rounded-lg bg-yellow-50">
    ...
    <ul className="text-yellow-800 text-sm space-y-1">
      <li>• Restrict traffic with firewall rules</li>
      <li>• Use fail2ban for SSH protection</li>
      <li>• Monitor tunnel connections</li>
    </ul>
  </div>
</div>
  ...
  <div className="space-y-4">
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="text-gray-600 text-sm mt-1">Fully outbound connection—safe for most enterprise networks</p>
      </div>
    </div>
  </div>
</div>
