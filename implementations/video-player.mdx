...
description: "Integrate live Rhombus camera streams into your web application using DashJS"
icon: "circle-play"
---

# Video Player Integration

Build real-time video streaming experiences with Rhombus security cameras using our DashJS player implementation. This guide provides a complete reference implementation for embedding authenticated camera feeds in your web applications.
